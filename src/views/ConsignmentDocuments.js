...
const ConsignmentDocuments = (props) => {
	const [loginStatus] = useContext(LoggedInStatusContext);

	localStorage.setItem('lastPage', '/consignment-documents/' + props.match.params.id);
				...
				<div className="container mx-auto">
					<div className="grid grid-cols-12 gap-x-12 gap-y-6">
						...
						<div className="col-span-10">
							<h2 className="mt-12 text-5xl font-light divide-solid leading-normal">Consignment documents and declarations</h2>	
...
export default ConsignmentDocuments;